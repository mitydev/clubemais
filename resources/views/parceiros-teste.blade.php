...
<head>
  ...
  @php
    ...
    $metaTitle = $page->meta_title ?? 'Clube+ | Parceiros';
...
<body class="bg-white">
  ...
  @if($sections->isNotEmpty())
    ...
    @endforeach
  @else
    {{-- Fallback estático se a página não tiver seções cadastradas --}}
    @includeIf('site.sections.hero_slider',     ['section' => null, 'isHome' => $isHome])
    @includeIf('site.sections.parc_rules',      ['section' => null])
    @includeIf('site.sections.parc_partner',    ['section' => null])
  @endif
