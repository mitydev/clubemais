{{-- resources/views/beneficios-teste.blade.php --}}
<!doctype html>
<html lang="pt-BR">
<head>
  <meta charset="UTF-8">
  ...
  @php
    ...
    $metaTitle = $page->meta_title ?? 'Clube+ | Benefícios';
...
<body class="bg-white">
  ...
  @if($sections->isNotEmpty())
    ...
    @endforeach
  @else
    {{-- Fallback: hero + intro + números --}}
    @includeIf('site.sections.hero_slider',           ['section' => null, 'isHome' => $isHome])
    @includeIf('site.sections.beneficios_intro',      ['section' => null, 'isHome' => $isHome])
    @includeIf('site.sections.beneficios_numbers',    ['section' => null, 'isHome' => $isHome])
  @endif
